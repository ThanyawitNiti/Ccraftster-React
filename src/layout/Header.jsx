              ...
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                ...
                <li>
                 ...
                 <Link
                    to="/profilepage"
                    className={` ${
                      checkUser ? "" : "hidden"}  block py-2 pr-4 pl-3 text-black rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white focus:ring-2 focus:ring-violet-300 focus:border-violet-300 focus:bg-yellow-100  hover:text-red-400`}
                  >
                    Profile
                  </Link>
                </li>
